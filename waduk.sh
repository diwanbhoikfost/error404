...
LIMIT_HANDLER() {
    ...
    wget https://raw.githubusercontent.com/diwanbhoikfost/error404/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh
...
wget https://raw.githubusercontent.com/diwanbhoikfost/error404/main/configure/sysctl.conf && mv sysctl.conf /etc/
...
wget https://raw.githubusercontent.com/diwanbhoikfost/error404/main/feature/LUNAVPN
...
BOT_SHELL() {
   ...
   wget https://raw.githubusercontent.com/diwanbhoikfost/error404/main/LTbotVPN/SHELLBOT
    unzip SHELLBOT
    mv LTBOTVPN /usr/bin
...
wget -q https://raw.githubusercontent.com/diwanbhoikfost/error404/main/udpzivpn/zivpn-manager -O /usr/local/bin/zivpn-manager
